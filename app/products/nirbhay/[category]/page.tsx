...
const CategoryPage = () => {
  ...
  useEffect(() => {
    ...
    const tshirts = [...Array(5)].map((_, index) => `/nirbh/stock/tshirt${index + 1}/tshirt-main.png`);
    const hoodies = [...Array(5)].map((_, index) => `/nirbh/stock/hoodie${index + 1}/hoodie-main.png`);
  ...
  const handleCategoryClick = (category: string) => {
    router.push(`/products/nirbhay/${category}`);
  };
